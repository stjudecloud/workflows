FROM stjudecloudacr.azurecr.io/stjudecloud/bio-base:latest
...
RUN gunzip GRCh38_no_alt.fa.gz
RUN echo "a6da8681616c05eb542f1d91606a7b2f  GRCh38_no_alt.fa" > GRCh38_no_alt.fa.md5
RUN md5sum -c GRCh38_no_alt.fa.md5

# Download GENCODE v30 GTF and verify contents
RUN wget ${GENCODE_v30_GTF_URL} -O gencode.v30.annotation.gtf.gz
RUN gunzip gencode.v30.annotation.gtf.gz
RUN echo "63770a3d2c6adb4d9d1bbc9ba3bd4adf  gencode.v30.annotation.gtf" > gencode.v30.annotation.gtf.md5
RUN md5sum -c gencode.v30.annotation.gtf.md5
...
RUN STAR --runMode genomeGenerate \
         ...
         --sjdbOverhang 125
RUN rm -rf GRCh38_no_alt* gencode.v30*