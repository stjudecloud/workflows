...
task fastp {
    meta {
        ...
        outputs: {
            read_one_fastq_gz: "The gzipped trimmed read one FASTQ file. Only generated if `read_two_fastq` is supplied. Has the name `~{prefix}.R1.fastq.gz`.",
            read_two_fastq_gz: "The gzipped trimmed read two FASTQ file. Only generated if `read_two_fastq` is supplied. Has the name `~{prefifx}.R2.fastq.gz.",
            single_end_reads_fastq_gz: "The trimmed Single-End FASTQ file. Only generated if `read_two_fastq` is not supplied. Has the name `~{prefix}.fastq.gz`.",
