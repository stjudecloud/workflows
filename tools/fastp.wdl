...
task fastp {
    meta {
        ...
        outputs: {
            read_one: "The trimmed read one FASTQ file",
            read_two: "The trimmed read two FASTQ file, if provided",
            fastp_html: "The HTML report generated by Fastp",
            fastp_json: "The JSON report generated by Fastp",
        }
    }
    ...
    output {
        File read_one = prefix + ".R1.fastq.gz"
        File? read_two = prefix + ".R2.fastq.gz"
        File fastp_html = prefix + ".fastp.html"
        File fastp_json = prefix + ".fastp.json"
    }
