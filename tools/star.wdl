...
task alignment {
    ...
    parameter_meta {
        ...
        outSAMmapqUnique: "`0-255`: the MAPQ value for unique mappers. Please note the STAR default produces errors downstream, as a MAPQ value of 255 is reserved to indicate a missing value. The default of this task is 254, which is the highest _valid_ MAPQ value, and likely what the author of STAR intended. **[STAR default]**: `255`. **[WDL default]**: `254`.",
