...
task subsample {
    meta {
        ...
        outputs: {
            subsampled_read1: "Subsampled read_one_fastq_gz FastQ"
            subsampled_read2: "Subsampled read_two_fastq_gz FastQ"
        }
    }
    ...
    Float read1_size = size(read_one_fastq_gz, "GiB")
    Float read2_size = if defined(read_two_fastq_gz) then size(read_two_fastq_gz, "GiB") else 0
