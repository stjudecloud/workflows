...
workflow quality_check_standard {
    meta {
        ...
        outputs: {
            ...
            raw_data: {
                description: "Any raw data not analyzed by MultiQC",
                help: "These files may be useful for more in-depth follow up. Some of these files can be large and are only conditionally created or output.",
            },
    ...
    output {
        ...
        Array[File] raw_data = select_all([
            kraken.sequences,
            comparative_kraken.sequences,
            junction_annotation.junctions,
        ])
