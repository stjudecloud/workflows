...
task combine_data {
    ...
    runtime {
        container: "ghcr.io/stjudecloud/pandas:branch-ci_python-2.2.1-1"
        memory: "~{memory_gb} GB"
        cpu: 1
...
task generate_umap {
    ...
    runtime {
        container: "ghcr.io/stjudecloud/umap:branch-ci_python-0.5.7-1"
        memory: "8 GB"
        cpu: 1
        disks: "~{disk_size_gb} GB"
        maxRetries: 1
...
task plot_umap {
    ...
    runtime {
        container: "ghcr.io/stjudecloud/python-plotting:branch-ci_python-1.1.0"
        memory: "4 GB"
        cpu: 1
        disks: "4 GB"
        maxRetries: 1
